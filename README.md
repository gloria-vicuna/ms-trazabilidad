...
<h3 align="center">Plaza de Comidas</h3>
  <p align="center">
    Microservicio de gestión de usuarios para la plataforma Plaza de Comidas (Pragma Power-Up).
    Implementado en arquitectura hexagonal con Java + Spring Boot + Gradle + MySQL.
  </p>
</div>
